...
@app.get("/select/juego/{id}", tags=["Juego"], response_model=Juego)
...
@app.get("/select/usuario/{id}", tags=["Usuario"], response_model=Usuario)
...
@app.get("/select/partida/{id}", tags=["Partida"], response_model=Partida)
...
@app.get("/select/puntaje/{id}", tags=["Puntaje"], response_model=Puntaje)
...
@app.get("/select/ranking/{id_modo}", tags=["Ranking"], response_model=Ranking)
